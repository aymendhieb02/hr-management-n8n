        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(authorize ->
                        authorize
                                ...
                                .requestMatchers(HttpMethod.PUT, "/api/jours-feries/**").hasAnyRole("MANAGER", "HR", "ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/api/jours-feries/**").hasAnyRole("MANAGER", "HR", "ADMIN")
                                .requestMatchers(HttpMethod.POST, "/api/raisons").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/api/raisons/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/api/raisons/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.POST, "/api/conge-types", "/api/conge-demande-statuts").hasAnyRole("HR", "ADMIN")
