...
public interface PipelineValidationRepository extends JpaRepository<PipelineValidation,Long>{
 List<PipelineValidation> findAllByOrderByNomAsc(); Optional<PipelineValidation> findFirstByEmployeIdAndActifTrue(Long employeId); boolean existsByEmployeIdAndActifTrueAndIdNot(Long employeId,Long id); boolean existsByEmployeIdAndIdNot(Long employeId,Long id);
}
