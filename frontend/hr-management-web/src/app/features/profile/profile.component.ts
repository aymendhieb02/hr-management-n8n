...
export class ProfileComponent implements OnInit{
 ...
 ngOnInit(){this.userService.findMe().subscribe({next:u=>{this.user.set(u);this.passwordOpen.set(Boolean(u.passwordChangeRequired));this.loading.set(false);},error:e=>{this.error.set(safeApiMessage(e,'Impossible de charger le profil.'));this.loading.set(false);}});}
